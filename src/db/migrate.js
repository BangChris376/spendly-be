...
const sql = `
  ...
  CREATE UNIQUE INDEX IF NOT EXISTS uniq_categories_user_name
  ...
  -- back-compat alters for databases that predate this migration
  DO $$ BEGIN
  ...
  DO $$ BEGIN
    CREATE TRIGGER trg_receipt_scans_updated_at BEFORE UPDATE ON receipt_scans
      FOR EACH ROW EXECUTE FUNCTION set_updated_at();
  EXCEPTION WHEN duplicate_object THEN NULL; END $$;
`;
